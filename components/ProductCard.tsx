        ...
        <div className="pt-3 border-t border-gray-100">
          ...
          <div className="space-y-3">
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 w-full bg-green-500 hover:bg-green-600 text-white px-5 py-3 rounded-lg font-bold text-sm transition-colors shadow-md hover:shadow-lg"
            >
          ...
          <p className="mt-3 text-xs leading-relaxed text-gray-500">
            Compra directa con checkout seguro o escríbenos si prefieres confirmar por WhatsApp.
          </p>
        </div>
      </div>
    </div>
